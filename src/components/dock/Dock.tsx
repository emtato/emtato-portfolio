...
export default function Dock({openBrowserCallback, openContact, openTempo, browserOpen}: DockProps) {
    ...
    return <div className="dock">
        ...
        <div className="dock-apps-container">
            ...
            <DockApp src="/assets/app-icons/linkedin.png" href="https://linkedin.com/in/emilia-ma"
                     hoverText="linkedin" browserOpen={browserOpen}/>
            ...
            <DockApp src="/assets/app-icons/contacts.png" hoverText="contacts" onClick={openContact}
                     browserOpen={browserOpen}/>
            <DockApp src="/assets/app-icons/music.png" hoverText="peak"
                     href="https://www.youtube.com/watch?v=kgAVoL49H3M" browserOpen={browserOpen}/>
            {/*https://www.youtube.com/watch?v=83C3TZ4Zm_o LEMONADE*/}
            <DockApp src="/assets/app-icons/trash.png" hoverText="trash" browserOpen={browserOpen}/>
        </div>
    </div>
}
